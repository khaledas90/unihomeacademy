    ...
    <section className="py-16 bg-gradient-to-b from-white to-[#fff5f2]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Card className="border-0 shadow-sm overflow-hidden bg-white h-full group transition-all duration-300">
            <CardContent className="p-8 h-full flex flex-col">
              <div className="flex-1 space-y-6">
               
                <div className="inline-block">
                  <span className="text-sm font-semibo  ld text-primary bg-primary/10 px-4 py-2 rounded-full flex items-center gap-2">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-primary cursor-pointer text-primary hover:bg-primary hover:text-white font-semibold text-base px-8 py-6 rounded-xl transition-all duration-300 group/btn w-fit"
                >
                  Explore All Courses
          ...
          <Card className="border-0 shadow-lg overflow-hidden bg-gradient-to-br from-[#1f447b] to-[#1a3a6b] text-white h-full group hover:shadow-xl transition-all duration-300">
            <CardContent className="p-8 h-full flex flex-col">
              <div className="flex-1 space-y-6"> 
                ...
                <Button
                  size="lg"
                  className="bg-[#f15a2d] cursor-pointer hover:bg-[#e04a1d] text-white font-semibold text-base px-8 py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group/btn w-fit"
                >
                  Claim Discount
                  <ArrowRight className="w-5 h-5 ml-2 group-hover/btn:translate-x-1 transition-transform" />
                </Button>
